...
if __name__=="__main__":
    ...
    for vid in df.index:
        ...
        if not yt_community_analyzer.is_community_garden(title, description, transcript):
            continue

        analysis = yt_community_analyzer.analyze(title, description, transcript)
        if analysis:
    ...
    df.to_csv("youtube_garden_results.csv", index=False)
